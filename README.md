...
Players solve series of riddles based on locations around Gitam campus. Each correct answer reveals next location and moves player across map. The game includes **30-second timer for each attempt, hints, file-based leaderboard, and a final treasure reveal**.
...
> `leaderboard.txt` is automatically created when game saves first score.
