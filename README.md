...
Players solve series of riddles based on locations around GITAM campus. Each correct answer reveals the next location and moves the player across map. The game includes **30-second timer for each attempt, hints, file-based leaderboard, and a final treasure reveal**.
